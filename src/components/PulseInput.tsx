        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="relative group/textarea">
            <textarea
              ...
              rows={4}
              className={`w-full rounded-2xl bg-slate-900/80 border p-4 text-[16px] text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500/50 transition-all duration-300 resize-none font-medium leading-relaxed ${showValidationErrors && messageValidationError
